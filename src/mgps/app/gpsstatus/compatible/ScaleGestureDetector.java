...
package mgps.app.gpsstatus.compatible;

import java.lang.reflect.Constructor;
import java.lang.reflect.Method;

import android.content.Context;
import mgps.app.gpsstatus.compatible.RealScaleGestureDetector;
...
public class ScaleGestureDetector {
	...
	public ScaleGestureDetector(Context context, SimpleOnScaleGestureListener simpleOnScaleGestureListener) {
		try {
			...
			Class<?> classRealScaleGestureDetector = Class.forName("mgps.app.gpsstatus.compatible.RealScaleGestureDetector");
