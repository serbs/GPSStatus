...
import mgps.app.gpsstatus.compatible.ScaleGestureDetector;
...
abstract public class GraphView extends LinearLayout {
	...
	private mgps.app.gpsstatus.compatible.ScaleGestureDetector scaleDetector;
	...
	synchronized public void setScalable(boolean scalable) {
		...
		if (scalable == true && scaleDetector == null) {
			...
			scaleDetector = new mgps.app.gpsstatus.compatible.ScaleGestureDetector(getContext(), new mgps.app.gpsstatus.compatible.ScaleGestureDetector.SimpleOnScaleGestureListener() {
				@Override
